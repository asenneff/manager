...
One is on the highest scale: Is it clear to my team what the end game is with this project? Do they now when they are done?  There is no worse feeling than what has come to be called the Death March - the endless stream of little bits of work that just don't seem to ever end.  A team should have a goal, that goal should be as near term as possible, and it should be clear when that goal has been reached to everyone on the team.
...
(I'll admit, defining scope clearly is much easier when cards are small.  So....)
	
**2.  Break the cards down**

At Church Community Builder we have 5 sizes of stories (2, 4, 8, 16 and 32).  Our job as leaders is to make sure there is never a 32. When someone estimates a card at 32, all that means is that we really don't know how long the card might actually take. _Spoiler: It's longer than 32_.
...
Once you know you have a Zombie,  the way you kill a zombie is by pairing or mobbing on it.
...
This is also where a big, visible daily spring boards are helpful.  There are a wide variety of sprint board designs that highlight when a card (or a whole batch of cards) ar stuck.  
	
However you do it, kill the zombies quickly.
	
**4. Shorter Sprints**

We have week long sprints at Church Community Builder, which are not overly long...but sprints can always be shortened. In this case it's not a matter of doing a 2 or 3 day sprint, but just turning every day of the week into it's own sprint.
...
An important thing here is to do it in a group setting.  There is value in hearing every team members's opinions 1:1, but be aware they each have a unique view of what is working and what is not, may not invdividually have the same conclusions, and benefit from hearing from each other. 
